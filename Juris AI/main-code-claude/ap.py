...
db_retriever = db.as_retriever(search_type="mmr", search_kwargs={"k": 10, "fetch_k": 20})

# DEBUG - remove after testing
test_docs = db_retriever.get_relevant_documents("term of copyright cinematograph film")
